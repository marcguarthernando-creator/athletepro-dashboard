...
const PlayerFisioReport: React.FC = () => {
    ...
    const sendEmail = () => {
        const subject = `Informe Fisioterapéutico Deportivo - ${player.name}`;
        const body = `Adjunto informe fisioterapéutico de ${player.name} con fecha ${new Date().toLocaleDateString()}.`;
        ...
        <div className="flex-1 flex flex-col h-full bg-background-dark/30 overflow-hidden">
            ...
            <div className="h-16 flex items-center px-8 bg-background-dark/50 border-b border-surface-border/50 justify-between flex-none">
                <div className="flex items-center gap-6">
                    <button
                        onClick={() => navigate('/fisio/players')}
            ...
            <div className="flex-1 overflow-y-auto p-10 flex justify-center items-start bg-[#1e2329]/50">
                ...
                >
                    ...
                    <div className="bg-[#1e3a8a] text-white py-2 px-6 flex justify-between items-center mb-6">
                        <h1 className="text-[16px] font-black uppercase tracking-[0.05em]">INFORME FISIOTERAPÉUTICO DEPORTIVO - CB BALONCESTO</h1>
...
export default PlayerFisioReport;
